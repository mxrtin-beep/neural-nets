...
// inverted format with a positive bmpInfoHeader_biHeight value.
   ...
   public int[][] fileToArray(String s, int dimA, int dimB)
   {
      ...
      try
      {
         ...
         {
            pels[indexY][indexX] = (int) Double.parseDouble(counter2.readLine());
            if(indexX < dimA - 1)
            {
               indexX++;
            }
    ...
    */
   public void doubleArrayToFile(String filename, double[][] pels)
   {
   ...
   /**
    * Converts a 2D array of ints to a String iterator.
...
// there is no color table for this true color image, so write out the pels
   ...
   public int[][] getPels(String filename)
   {
